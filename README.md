# Yildiz-Engine module-graphic-ogre-linux64.
...
This will compile the source code, then run the unit tests, and finally build a jar file and SO for the environment you chose.
